...
public class Playfair_Encrypt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playfair__encrypt);
            ...
            public void onClick(View v) {
                ...
                if(plain.equals(null) || plain.equals("")){
                    ...
                    if(plain.length()%2==0) {
                        ...
                        matrix(key);
                        String res = playfairEncryption(plain);
                        ...
                        matrix(key);
                        String res = playfairEncryption(plain+"Z");
                        System.out.println(res);
                        if (!res.equals("no")) {
                            restext.setText("Encrypted Text:   "+res);
                        }
